...
function GenerateIdCard() {
  ...
  const fetchStudents = async () => {
    ...
    const res = await allStudents(user.school, user._id, token);
    console.log(res);
    if (res.err) {
      return;
    } else {
  ...
  const getSchoolData = async () => {
    const res = await schoolProfile(user.school, user._id);
    setDataSchool({
      city: res.data.city,
            ...
            <ModalBody style={{ padding: "2rem" }}>
              {loadingID ? (
                ...
                >
                  ...
                  <div
                    className="identityCard__profile"
                    style={{
                      backgroundImage: checked
                        ? `linear-gradient(rgba(${hexToRgb(color1).r},${
                            hexToRgb(color1).g
                          },${
                            hexToRgb(color1).b
                          },70%) 46%, ${color2} 100%), url(${logo})`
                        : null,
                      backgroundPosition: "center",
                      backgroundRepeat: "no-repeat",
                      backgroundSize: "contain",
                  ...
                  >
                    ...
                    <ul className="identityCard__list list-unstyled">
                      ...
                      <li>
                        <strong>Section :</strong> <span>{section}</span>
                      </li>
                      <li>
                        <strong>Roll No. :</strong>{" "}
                        <span>{stuData.roll_number}</span>
                      </li>
                      <li>
                        <strong>Gender :</strong> <span>{stuData.gender}</span>
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Contact No. :</strong> <span>+91 {phone}</span>
                      </li>
                      <li>
                        <strong>Blood Group :</strong>{" "}
                        <span>{stuData.bloodgroup}</span>
                      </li>
                    </ul>
                  </div>
                  <footer className="identityCard__footer">
                    <div className="filled">
                      <span>
                        {IDdataSchool.address} - {dataSchool.city},{" "}
                        {dataSchool.state} - {dataSchool.pincode} - +91{" "}
                        {IDdataSchool.phone}
                      </span>
                    </div>
                  </footer>
